...
##Liste_Licences_DEDOS = {"VT710821":"DEBROISE;Laurent",
##                        "VT841052":"DIMOUAMOUA;GAETAN",
##                        "VT890456":"RAMIREZ;GUILLAUME",
##                        "VT751789":"CHOUPAS;REGIS",
##                        "VT772029":"El Oukid;Mehdi"}

Liste_Licences_DEDOS = {"VT710821":"DEBROISE",
                        "VT841052":"DIMOUAMOUA",
                        "VT890456":"RAMIREZ",
                        "VT751789":"CHOUPAS",
                        "VT772029":"EL OUKID",
...
for Num_licence in Liste_Licences_DEDOS.keys():
    ...
    if Licence_DEDO>0 :
        ...
        print(Num_licence +";" + Liste_Licences_DEDOS[Num_licence] +";;" + Game_Nb + ";" +Game_Date + ";;" + Game_Lieu + ";" +Activite + ";" + TEAM_HOME +" - " + TEAM_VISITOR)
